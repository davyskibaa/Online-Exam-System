<?php require APPROOT . '/view/inc/header.php'; ?>
    ...
    <div class="card card-body bg-light mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="text-right">Exam Title: <strong><?php echo $data['quiz_title']; ?></strong></p>
                <p class="text-right">Number of Questions: <strong><?php echo $data['quiz_question_count']; ?></strong></p>
            </div>
        </div>
    </div>
